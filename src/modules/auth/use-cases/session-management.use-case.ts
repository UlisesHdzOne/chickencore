...
export class SessionManagementUseCase {
  ...
  async logoutSpecificSession(userId: number, sessionId: string): Promise<{ message: string }> {
  ...
  async logoutAllDevices(userId: number): Promise<{ message: string; sessionsLoggedOut: number }> {
